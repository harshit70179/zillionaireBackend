exports.table = [
  ...
  },
  {
   ...
   query:"CREATE TABLE IF NOT EXISTS main_category(id INT AUTO_INCREMENT PRIMARY KEY,name VARCHAR(255) NULL,status ENUM('0','1') NULL,total_category INT DEFAULT 0,total_sub_category INT DEFAULT 0,createdAt timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,updatedAt timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP)"
  },
  {
    tableName:"category",
    query:"CREATE TABLE IF NOT EXISTS category(id INT AUTO_INCREMENT PRIMARY KEY,main_category_id INT NULL,name VARCHAR(255) NULL,status ENUM('0','1') NULL,total_sub_category INT DEFAULT 0,size TEXT NULL,start VARCHAR(255) NULL,end VARCHAR(255) NULL,step VARCHAR(255) NULL,size_name VARCHAR(255) NULL,createdAt timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,updatedAt timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP)"
  },
  {
